...
class PolycysticKidneySeg(ScriptedLoadableModule):
    ...
    def registerSampleData(self):
        ...
        SampleData.SampleDataLogic.registerCustomSampleDataSource(
            ...
            uris="https://github.com/conze/SlicerPolycysticKidneySeg/releases/download/v.1.0.0/T2_PKDIA_test_file.nii.gz",
        ...
        SampleData.SampleDataLogic.registerCustomSampleDataSource(
            ...
            uris="https://github.com/conze/SlicerPolycysticKidneySeg/releases/download/v.1.0.0/CT_PKDIA_test_file.nii.gz",
